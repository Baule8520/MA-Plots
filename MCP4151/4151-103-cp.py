...
df_1 = pd.read_csv('data/pot_u/4151-103-up-cp.txt', sep=' - ', header=None, names=["Pot", "A0", "U"])
...
df_2 = pd.read_csv('data/pot_r/4151-103-up-cp.txt', sep=' - ', header=None, names=["Pot", "A0", "U", "R"])
