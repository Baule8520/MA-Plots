...
df_1 = pd.read_csv('data/pot_u/4151-104-up-nm.txt', sep=' - ', header=None, names=["Pot", "A0", "U"])
...
df_2 = pd.read_csv('data/pot_r/4151-104-up-nm.txt', sep=' - ', header=None, names=["Pot", "A0", "U", "R"])
...
plt.savefig('results/4151-104-nm.svg', format='svg', dpi=1200)